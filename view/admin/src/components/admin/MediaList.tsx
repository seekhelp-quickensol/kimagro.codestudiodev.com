  ...
  return (
    <div className="p-4 bg-white rounded-xl shadow">
      <div className="filter-container flex flex-wrap mb-4 gap-4">
        <div className="w-full md:w-1/3 lg:w-1/3 mb-4 md:mb-0 realtive">
